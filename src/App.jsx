...
const TEAMS = {
  ...
  chi: { name: "Bears", color: "#0B162A", color2: "#C83803", p: {
    ...
    F7: [["Dick Butkus",1965,1973,98.7],["Mike Singletary",1981,1992,90],["Richard Dent",1983,1993,88],["Khalil Mack",2018,2021,82],["Brian Urlacher",2000,2012,88]],
  ...
  cin: { name: "Bengals", color: "#FB4F14", color2: "#000000", p: {
    ...
    TE: [["Bob Trumpy",1968,1977,72],["Rodney Holman",1982,1992,65],["Tyler Eifert",2013,2019,60],["Reggie Kelly",2003,2009,62]],
    F7: [["Tim Krumrie",1983,1994,72],["Justin Smith",2001,2007,74],["Geno Atkins",2010,2020,90.6],["Trey Hendrickson",2021,2025,78]],
    DB: [["Ken Riley",1969,1983,91.6],["Lemar Parrish",1970,1977,74],["David Fulcher",1986,1992,72],["Jessie Bates III",2018,2022,70],["Deltha O'Neal",2004,2008,72]] } },
  cle: { name: "Browns", color: "#311D00", color2: "#FF3C00", p: {
    QB: [["Otto Graham",1946,1955,95],["Brian Sipe",1974,1983,74],["Bernie Kosar",1985,1993,70],["Baker Mayfield",2018,2021,62],["Tim Couch",1999,2003,62]],
    RB: [["Jim Brown",1957,1965,100],["Leroy Kelly",1964,1973,82],["Kevin Mack",1985,1993,66],["Nick Chubb",2018,2024,78],["William Green",2002,2004,58]],
    WR: [["Paul Warfield",1964,1977,86],["Webster Slaughter",1986,1991,66],["Josh Gordon",2012,2014,66],["Jarvis Landry",2018,2021,68],["Amari Cooper",2022,2024,68],["Braylon Edwards",2005,2009,76]],
    TE: [["Ozzie Newsome",1978,1990,96.6],["David Njoku",2017,2025,66],["Kellen Winslow II",2004,2008,78]],
  ...
  mia: { name: "Dolphins", color: "#008E97", color2: "#F58220", p: {
    ...
    WR: [["Paul Warfield",1970,1974,78],["Mark Clayton",1983,1992,76],["Mark Duper",1982,1992,74],["Jarvis Landry",2014,2017,66],["Tyreek Hill",2022,2025,82],["Chris Chambers",2001,2007,74]],
  ...
  sea: { name: "Seahawks", color: "#002244", color2: "#69BE28", p: {
    ...
    DB: [["Dave Brown",1976,1986,70],["Kenny Easley",1981,1987,82],["Earl Thomas",2010,2018,86],["Richard Sherman",2011,2017,84],["Kam Chancellor",2010,2017,76],["Marcus Trufant",2003,2012,76]] } },
  ...
  ten: { name: "Titans / Oilers", color: "#4B92DB", color2: "#0C2340", p: {
    ...
    TE: [["Frank Wycheck",1995,2003,68],["Delanie Walker",2013,2018,70],["Jared Cook",2009,2012,56],["Mike Barber",1976,1983,74]],
  ...
  was: { name: "Commanders", color: "#5A1414", color2: "#FFB612", p: {
    QB: [["Sammy Baugh",1937,1952,97],["Sonny Jurgensen",1964,1974,82],["Joe Theismann",1974,1985,78],["Kirk Cousins",2012,2017,68],["Jayden Daniels",2024,2025,72],["Jason Campbell",2006,2009,62]],
    ...
    DB: [["Ken Houston",1973,1980,82],["Darrell Green",1983,2002,97.6],["Champ Bailey",1999,2003,74],["Sean Taylor",2004,2007,72],["Josh Norman",2016,2019,74]] } },
};
