...
const TEAMS = {
  ari: { name: "Cardinals", color: "#97233F", p: {
    ...
    F7: [["Eric Swann",1991,1999,72],["Simeon Rice",1996,2000,78],["Calais Campbell",2008,2016,85],["Chandler Jones",2016,2021,84]],
    DB: [["Larry Wilson",1960,1972,88],["Aeneas Williams",1991,2000,85],["Patrick Peterson",2011,2020,84],["Budda Baker",2017,2025,78]] } },
  atl: { name: "Falcons", color: "#A71930", p: {
    ...
    WR: [["Andre Rison",1990,1994,74],["Roddy White",2005,2015,83],["Julio Jones",2011,2020,92],["Drake London",2022,2025,68]],
  ...
  bal: { name: "Ravens", color: "#241773", p: {
    ...
    F7: [["Ray Lewis",1996,2012,97],["Terrell Suggs",2003,2018,88],["Haloti Ngata",2006,2014,80],["Roquan Smith",2022,2025,76]],
    DB: [["Rod Woodson",1998,2001,78],["Ed Reed",2002,2012,94],["Marlon Humphrey",2017,2025,76]] } },
  buf: { name: "Bills", color: "#00338D", p: {
    ...
    F7: [["Bruce Smith",1985,1999,97],["Cornelius Bennett",1987,1995,80],["Ed Oliver",2019,2025,68],["Von Miller",2022,2024,64]],
  ...
  chi: { name: "Bears", color: "#0B162A", p: {
    ...
    TE: [["Mike Ditka",1961,1966,82],["Greg Olsen",2007,2010,64],["Cole Kmet",2020,2025,58]],
    F7: [["Dick Butkus",1965,1973,94],["Mike Singletary",1981,1992,90],["Richard Dent",1983,1993,88],["Khalil Mack",2018,2021,82]],
  ...
  cin: { name: "Bengals", color: "#FB4F14", p: {
    ...
    F7: [["Tim Krumrie",1983,1994,72],["Justin Smith",2001,2007,74],["Geno Atkins",2010,2020,84],["Trey Hendrickson",2021,2025,78]],
    DB: [["Ken Riley",1969,1983,84],["Lemar Parrish",1970,1977,74],["David Fulcher",1986,1992,72],["Jessie Bates III",2018,2022,70]] } },
  cle: { name: "Browns", color: "#311D00", p: {
    ...
    TE: [["Ozzie Newsome",1978,1990,88],["David Njoku",2017,2025,66]],
  ...
  dal: { name: "Cowboys", color: "#003594", p: {
    QB: [["Roger Staubach",1969,1979,90],["Troy Aikman",1989,2000,85],["Tony Romo",2004,2016,78],["Dak Prescott",2016,2025,82]],
    ...
    F7: [["Bob Lilly",1961,1974,94],["Randy White",1975,1988,92],["DeMarcus Ware",2005,2013,90],["Micah Parsons",2021,2025,85]],
  ...
  den: { name: "Broncos", color: "#FB4F14", p: {
    ...
    TE: [["Riley Odoms",1972,1983,72],["Shannon Sharpe",1990,2003,88],["Julius Thomas",2011,2014,58]],
  ...
  det: { name: "Lions", color: "#0076B6", p: {
    ...
    RB: [["Billy Sims",1980,1984,72],["Barry Sanders",1989,1998,97],["Kevin Jones",2004,2008,56],["Jahmyr Gibbs",2023,2025,72]],
    WR: [["Herman Moore",1991,2001,78],["Johnnie Morton",1994,2001,62],["Calvin Johnson",2007,2015,92],["Amon-Ra St. Brown",2021,2025,80]],
  ...
  gb: { name: "Packers", color: "#203731", p: {
    QB: [["Bart Starr",1956,1971,86],["Brett Favre",1992,2007,92],["Aaron Rodgers",2005,2022,96],["Jordan Love",2023,2025,66]],
  ...
  hou: { name: "Texans", color: "#03202F", p: {
    ...
    F7: [["Mario Williams",2006,2011,78],["J.J. Watt",2011,2020,94],["Whitney Mercilus",2012,2021,66],["Will Anderson Jr.",2023,2025,70]],
  ...
  jax: { name: "Jaguars", color: "#006778", p: {
    ...
    RB: [["Fred Taylor",1998,2008,80],["Maurice Jones-Drew",2006,2013,78],["Travis Etienne",2021,2025,62]],
    WR: [["Jimmy Smith",1995,2005,82],["Keenan McCardell",1996,2001,70],["Allen Robinson",2014,2017,66],["Brian Thomas Jr.",2024,2025,66]],
  ...
  kc: { name: "Chiefs", color: "#E31837", p: {
    QB: [["Len Dawson",1962,1975,86],["Trent Green",2001,2006,70],["Alex Smith",2013,2017,66],["Patrick Mahomes",2017,2025,98]],
    ...
    WR: [["Otis Taylor",1965,1975,78],["Dwayne Bowe",2007,2014,68],["Tyreek Hill",2016,2021,86],["Rashee Rice",2023,2025,60]],
    TE: [["Fred Arbanas",1962,1970,70],["Tony Gonzalez",1997,2008,94],["Travis Kelce",2013,2025,92]],
  ...
  lac: { name: "Chargers", color: "#0080C6", p: {
    ...
    WR: [["Lance Alworth",1962,1970,90],["Charlie Joiner",1976,1986,78],["Vincent Jackson",2005,2011,70],["Keenan Allen",2013,2023,82]],
    TE: [["Kellen Winslow",1979,1987,88],["Antonio Gates",2003,2018,90]],
  ...
  lar: { name: "Rams", color: "#003594", p: {
    ...
    RB: [["Eric Dickerson",1983,1987,88],["Marshall Faulk",1999,2005,90],["Steven Jackson",2004,2012,78],["Todd Gurley",2015,2019,74]],
    ...
    F7: [["Deacon Jones",1961,1971,94],["Merlin Olsen",1962,1976,92],["Jack Youngblood",1971,1984,88],["Kevin Greene",1985,1992,80],["Aaron Donald",2014,2023,97]],
  ...
  lv: { name: "Raiders", color: "#000000", p: {
    ...
    WR: [["Fred Biletnikoff",1965,1978,82],["Cliff Branch",1972,1985,80],["Tim Brown",1988,2003,88],["Amari Cooper",2015,2018,66],["Davante Adams",2022,2024,76]],
    ...
    DB: [["Willie Brown",1967,1978,84],["Lester Hayes",1977,1986,80],["Mike Haynes",1983,1989,80],["Charles Woodson",1998,2005,82]] } },
  mia: { name: "Dolphins", color: "#008E97", p: {
    ...
    F7: [["Nick Buoniconti",1969,1976,84],["Bill Stanfill",1969,1976,76],["Zach Thomas",1996,2007,84],["Jason Taylor",1997,2011,88],["Christian Wilkins",2019,2023,66]],
  ...
  min: { name: "Vikings", color: "#4F2683", p: {
    ...
    RB: [["Chuck Foreman",1973,1979,76],["Robert Smith",1993,2000,72],["Adrian Peterson",2007,2016,90],["Dalvin Cook",2017,2022,72]],
  ...
  ne: { name: "Patriots", color: "#002244", p: {
    ...
    DB: [["Raymond Clayborn",1977,1989,74],["Ty Law",1995,2004,82],["Rodney Harrison",2003,2008,74],["Devin McCourty",2010,2022,78],["Stephon Gilmore",2017,2020,76]] } },
  ...
  nyg: { name: "Giants", color: "#0B2265", p: {
    ...
    WR: [["Homer Jones",1964,1969,72],["Amani Toomer",1996,2008,72],["Plaxico Burress",2005,2008,66],["Odell Beckham Jr.",2014,2018,78],["Malik Nabers",2024,2025,66]],
  ...
  nyj: { name: "Jets", color: "#125740", p: {
    ...
    WR: [["Don Maynard",1960,1972,86],["Al Toon",1985,1992,72],["Wayne Chrebet",1995,2005,68],["Garrett Wilson",2022,2025,68]],
    ...
    DB: [["Bill Baird",1963,1969,64],["Victor Green",1993,2001,60],["Darrelle Revis",2007,2016,88],["Sauce Gardner",2022,2025,74]] } },
  ...
  sea: { name: "Seahawks", color: "#002244", p: {
    ...
    WR: [["Steve Largent",1976,1989,88],["Brian Blades",1988,1998,66],["Doug Baldwin",2011,2018,72],["Tyler Lockett",2015,2024,68],["DK Metcalf",2019,2024,74]],
  ...
  sf: { name: "49ers", color: "#AA0000", p: {
    QB: [["Y.A. Tittle",1951,1960,76],["Joe Montana",1979,1992,96],["Steve Young",1987,1999,92],["Jeff Garcia",1999,2003,68],["Brock Purdy",2022,2025,70]],
  ...
  ten: { name: "Titans / Oilers", color: "#4B92DB", p: {
    QB: [["George Blanda",1960,1966,74],["Dan Pastorini",1971,1979,66],["Warren Moon",1984,1993,86],["Steve McNair",1995,2005,82],["Ryan Tannehill",2019,2023,66]],
    ...
    F7: [["Elvin Bethea",1968,1983,82],["Robert Brazile",1975,1984,82],["Ray Childress",1985,1995,78],["Jevon Kearse",1999,2003,74],["Jurrell Casey",2011,2019,76],["Harold Landry",2018,2025,64]],
    DB: [["Ken Houston",1967,1972,84],["Blaine Bishop",1993,2001,66],["Samari Rolle",1998,2004,66],["Kevin Byard",2016,2022,74]] } },
  was: { name: "Commanders", color: "#5A1414", p: {
    QB: [["Sammy Baugh",1937,1952,92],["Sonny Jurgensen",1964,1974,82],["Joe Theismann",1974,1985,78],["Kirk Cousins",2012,2017,68],["Jayden Daniels",2024,2025,72]],
    ...
    DB: [["Ken Houston",1973,1980,82],["Darrell Green",1983,2002,88],["Champ Bailey",1999,2003,74],["Sean Taylor",2004,2007,72]] } },
};
      ...
      <div className="wr">
        ...
        <div className="panel">
          ...
          {franchise && !locksValid && (
            <div className="mono" style={{ fontSize: 11, color: "#C8912F", marginTop: 8 }}>
          ...
          {editingLocks ? (
            ERA_KEYS.map(k => (
              <div key={k} style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 6 }}>
                ...
                <div className="slotname" style={{ fontSize: 13, width: 62, flexShrink: 0 }}>{ERAS[k].label}</div>
              ...
              {SLOTS.map(s => {
                ...
                return (
                  <div key={s.id} className={"slotbtn static" + (filled ? " done" : "")}>
                    ...
                    {scarce && (
                      <div className="mono" style={{ fontSize: 9, color: "#C8342B", marginTop: 2 }}>
                        {o.count} left
                      </div>
                    )}
                  </div>
      ...
      <div className="panel" style={{ marginTop: 10 }}>
        ...
        {calib.fitted ? (
          <>
            ...
            <div className="mono" style={{ fontSize: 11, color: calib.r2 > 0.7 ? "#4E9E9A" : "#C8912F", marginTop: 6 }}>
